-- =============================================
-- SECTION 1: CLEAN DROP (SAFE RE-RUN)
-- =============================================
...
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE CLASSROOM_FACILITY CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/

-- =============================================
-- SECTION 2: DDL (DATA DEFINITION)
-- =============================================
...
CREATE TABLE EMPLOYMENT_CONTRACT (
    ...
    CONSTRAINT CHK_EMP_SALARY CHECK (CONTRACT_SALARY > 0),
    CONSTRAINT CHK_EMP_DATES CHECK (CONTRACT_END >= CONTRACT_START)
);
...
CREATE TABLE PARENT_GUARDIAN (
    ...
    CONSTRAINT CHK_PARENT_INCOME CHECK (HOUSEHOLD_INCOME >= 0)
);
...
CREATE TABLE VOLUNTEER (
    ...
    CONSTRAINT CHK_VOL_TRANSPORT CHECK (VOLUNTEER_OWN_TRANSPORT IN ('Y', 'N'))
);
...
CREATE TABLE BUDGET (
    ...
    CONSTRAINT CHK_BUDGET_ALLOC CHECK (TOTAL_ALLOCATION >= 0)
);
...
CREATE TABLE PROGRAM (
    ...
    CONSTRAINT CHK_PROG_DATES CHECK (PROGRAM_END_DATE >= PROGRAM_START_DATE)
);
...
CREATE TABLE EXPENSE (
    ...
    FOREIGN KEY (PROGRAM_ID) REFERENCES PROGRAM(PROGRAM_ID),
    CONSTRAINT CHK_EXPENSE_AMT CHECK (EXPENSE_AMOUNT > 0)
);
...
-- ============================================================
-- SECTION 3: DDL (DROP TABLE)
-- ============================================================
DROP TABLE CLASSROOM_FACILITY CASCADE CONSTRAINTS;
